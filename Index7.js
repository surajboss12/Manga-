...
function createMangaCard(title, imageUrl) {
    return `
        <div style="display:inline-block; margin:10px; text-align:center;">
            <img src="${imageUrl}" alt="${title}" style="width:150px; height:225px; object-fit:cover; border-radius:5px; box-shadow:0 0 10px #0003;">
...
async function fetchRecent() {
    const recentChaptersUrl = `${proxy}https://api.mangadex.org/chapter?limit=15&translatedLanguage[]=en&order[publishAt]=desc&includes[]=manga&includes[]=cover_art`;
    try {
